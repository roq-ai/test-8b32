...
import { deleteEndCustomerById } from 'apiSdk/end-customers';
              ...
              {hasAccess('end_customer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/end-customers/create?company_id=${data?.id}`}>
                    ...
                    <Table variant="simple">
                      ...
                      <Tbody>
                        {data?.end_customer?.map((record) => (
                          <Tr
                            cursor="pointer"
                            onClick={() => router.push(`/end-customers/view/${record.id}`)}
                            key={record.id}
                          >
                            ...
                            <Td>
                              {hasAccess('end_customer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                                <NextLink
                                  onClick={(e) => e.stopPropagation()}
                                  passHref
                                  href={`/end-customers/edit/${record.id}`}
                                >
